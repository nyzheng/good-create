...
document.addEventListener('DOMContentLoaded', () => {
    const target = document.querySelector('.area2 > .content > .title-box.mobile')
    const observer = new IntersectionObserver(
        (entries) => {
            entries.forEach((entry) => {
                if (entry.isIntersecting) {
...
/** area5**/
document.addEventListener('DOMContentLoaded', () => {
    const target = document.querySelector('.area5 > .content > .title-box .title-1 ')
    const observer = new IntersectionObserver(
        (entries) => {
            entries.forEach((entry) => {
                if (entry.isIntersecting) {
...
document.addEventListener('DOMContentLoaded', () => {
    const target = document.querySelector('.area5 > .content > .title-box .title-3')
    const observer = new IntersectionObserver(
        (entries) => {
            entries.forEach((entry) => {
                if (entry.isIntersecting) {
...
document.addEventListener('DOMContentLoaded', () => {
    const target = document.querySelector('.area5 > .content > .title-box.mobile')
    const observer = new IntersectionObserver(
        (entries) => {
            entries.forEach((entry) => {
                if (entry.isIntersecting) {
...
// document.addEventListener('DOMContentLoaded', () => {
//     const target = document.querySelector('.area5 > .content > .circle.mobile')
//     const observer = new IntersectionObserver(
//         (entries) => {
//             entries.forEach((entry) => {
//                 if (entry.isIntersecting) {
...
document.addEventListener('DOMContentLoaded', () => {
    const target = document.querySelector(' .area6 > .content > .title-box');
    const observer = new IntersectionObserver(
        (entries) => {
            entries.forEach((entry) => {
                if (entry.isIntersecting) {
...
document.addEventListener('DOMContentLoaded', () => {
    const target = document.querySelector('.area7 > .content > .title-box > .title > .container ')
    const observer = new IntersectionObserver(
        (entries) => {
            entries.forEach((entry) => {
                if (entry.isIntersecting) {
...
document.addEventListener('DOMContentLoaded', () => {
    const target = document.querySelector('.area7 > .content > .title-box .title-2')
    const observer = new IntersectionObserver(
        (entries) => {
            entries.forEach((entry) => {
                if (entry.isIntersecting) {
